  ...
  static Future<List<InspectionModal>> getInspectionList(
    ...
    try {
      ...
      for (var row in cursor) {
        ...
        final poList =
            await POItemDtlHandler.getPOList(inspectionModel.pRowID!);
        ...
        final importantList = await ItemInspectionDetailHandler.isImportant(
            qrHdrId: inspectionModel.pRowID!, qrPoItemHdrId: '');
      ...
      FslLog.i(_logger,
          "Count of found QRFeedbackhdr: ${inspectionArrayList.length}");
    } catch (e) {
