...
class QRPOItemDtlOnSiteTestTable {
  static const String TABLE_NAME = "QRPOItemDtl_OnSite_Test";
  ...
  static const String onSiteTestID = "OnSiteTestID";
  static const String inspectionLevelID = "InspectionLevelID";
  ...
  CREATE TABLE IF NOT EXISTS $TABLE_NAME (
    ...
    $onSiteTestID TEXT DEFAULT '',
    $inspectionLevelID TEXT DEFAULT '',
